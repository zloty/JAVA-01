...
public class Rpcfx {
  static {
    ParserConfig.getGlobalInstance().addAccept("com.zyc");
  }
  ...
  private static <T> T create(final Class<T> serviceClass, final String url, Filter ... filters) {
    // todo 替换动态代理 -> AOP
  ...
  public static class RpcInvocationHandler implements InvocationHandler{
    ...
    private RpcfxResponse post(RpcfxRequest req, String url) throws IOException {
      ...
      // todo 尝试使用httpclient或者netty client
